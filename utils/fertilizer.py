fertilizer_dic = {
        'NHigh': """
        <br/> <b>Here is what you should do :</b>
        ...
        <br/>7. <i>Use NPK fertilizers with high Nitrogen.
...
analysis_dic = {
    'NHigh':  "The soil is high in Nitrogen and might give rise to weeds.",
    'Nlow': "Nitrogen in the soil is very low.",
    'PHigh': "The soil is high in Phosphorus.",
    'Plow': "The soil has low amount of Phosphorus.",
    'KHigh': "The soil is high in Potassium.",
    'Klow': "Potassium in the soil is low."
}